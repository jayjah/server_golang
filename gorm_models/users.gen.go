...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Loginname = field.NewString(tableName, "loginname")
	_user.Email = field.NewString(tableName, "email")
	_user.Password = field.NewString(tableName, "password")
	_user.Birthdate = field.NewTime(tableName, "birthdate")
	_user.Lastlogin = field.NewTime(tableName, "lastlogin")
	_user.Newsletter = field.NewBool(tableName, "newsletter")
	_user.Role = field.NewString(tableName, "role")
	_user.Externalid = field.NewString(tableName, "externalid")
	_user.Createdat = field.NewTime(tableName, "createdat")
	_user.PushtokenID = field.NewInt64(tableName, "pushtoken_id")
...
func (u *user) updateTableName(table string) *user {
	...
	u.Birthdate = field.NewTime(table, "birthdate")
	u.Lastlogin = field.NewTime(table, "lastlogin")
	u.Newsletter = field.NewBool(table, "newsletter")
	u.Role = field.NewString(table, "role")
	u.Externalid = field.NewString(table, "externalid")
	u.Createdat = field.NewTime(table, "createdat")
	u.PushtokenID = field.NewInt64(table, "pushtoken_id")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["birthdate"] = u.Birthdate
	u.fieldMap["lastlogin"] = u.Lastlogin
	u.fieldMap["newsletter"] = u.Newsletter
	u.fieldMap["role"] = u.Role
	u.fieldMap["externalid"] = u.Externalid
	u.fieldMap["createdat"] = u.Createdat
	u.fieldMap["pushtoken_id"] = u.PushtokenID
}
