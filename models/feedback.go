...
var FeedbackWhere = struct {
	...
	Name:      whereHelperstring{field: "\"feedback\".\"name\""},
	Message:   whereHelperstring{field: "\"feedback\".\"message\""},
	Createdat: whereHelpertime_Time{field: "\"feedback\".\"createdat\""},
}
...
var (
	feedbackAllColumns            = []string{"id", "name", "message", "createdat"}
	feedbackColumnsWithoutDefault = []string{"name", "message"}
	feedbackColumnsWithDefault    = []string{"id", "createdat"}
...
func (o *Feedback) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"feedback\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert feedback")
	}
