...
var LocationWhere = struct {
	...
	Longitude:        whereHelperfloat64{field: "\"locations\".\"longitude\""},
	Latitude:         whereHelperfloat64{field: "\"locations\".\"latitude\""},
	City:             whereHelperstring{field: "\"locations\".\"city\""},
	Address:          whereHelperstring{field: "\"locations\".\"address\""},
	Postalcode:       whereHelperstring{field: "\"locations\".\"postalcode\""},
	Name:             whereHelperstring{field: "\"locations\".\"name\""},
	ID:               whereHelperint64{field: "\"locations\".\"id\""},
	Shortdescription: whereHelperstring{field: "\"locations\".\"shortdescription\""},
	Text:             whereHelpernull_String{field: "\"locations\".\"text\""},
	Createdat:        whereHelpertime_Time{field: "\"locations\".\"createdat\""},
	Updatedat:        whereHelpertime_Time{field: "\"locations\".\"updatedat\""},
	ImageID:          whereHelperint64{field: "\"locations\".\"image_id\""},
}
...
func (r *locationR) GetImage() *Image {
	if r == nil {
		return nil
	}
	return r.Image
...
func (r *locationR) GetLocationImages() LocationImageSlice {
	if r == nil {
		return nil
	}
...
func (r *locationR) GetTrainings() TrainingSlice {
	if r == nil {
		return nil
	}
	return r.Trainings
...
var (
	locationAllColumns            = []string{"longitude", "latitude", "city", "address", "postalcode", "name", "id", "shortdescription", "text", "createdat", "updatedat", "image_id"}
	locationColumnsWithoutDefault = []string{"longitude", "latitude", "city", "address", "postalcode", "name", "shortdescription", "image_id"}
	locationColumnsWithDefault    = []string{"id", "text", "createdat", "updatedat"}
...
func (o *Location) Image(mods ...qm.QueryMod) imageQuery {
...
func (o *Location) LocationImages(mods ...qm.QueryMod) locationImageQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"location_images\".\"location_id\"=?", o.ID),
	)
...
func (o *Location) Trainings(mods ...qm.QueryMod) trainingQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"trainings\".\"location_id\"=?", o.ID),
	)
...
func (locationL) LoadImage(ctx context.Context, e boil.ContextExecutor, singular bool, maybeLocation interface{}, mods queries.Applicator) error {
	var slice []*Location
	var object *Location
...
func (locationL) LoadLocationImages(ctx context.Context, e boil.ContextExecutor, singular bool, maybeLocation interface{}, mods queries.Applicator) error {
	var slice []*Location
	var object *Location
	...
	query := NewQuery(
		...
		qm.WhereIn(`location_images.location_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (locationL) LoadTrainings(ctx context.Context, e boil.ContextExecutor, singular bool, maybeLocation interface{}, mods queries.Applicator) error {
	var slice []*Location
	var object *Location
	...
	query := NewQuery(
		qm.From(`trainings`),
		qm.WhereIn(`trainings.location_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// SetImage of the location to the related item.
// Sets o.R.Image to related.
// Adds o to related.R.Locations.
func (o *Location) SetImage(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Image) error {
	var err error
	if insert {
...
func (o *Location) AddLocationImages(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*LocationImage) error {
	var err error
...
// Sets related.R.Location appropriately.
func (o *Location) AddTrainings(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Training) error {
	var err error
	for _, rel := range related {
		if insert {
...
// Sets o.R.Location's Trainings accordingly.
// Replaces o.R.Trainings with related.
// Sets related.R.Location's Trainings accordingly.
func (o *Location) SetTrainings(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Training) error {
	query := "update \"trainings\" set \"location_id\" = null where \"location_id\" = $1"
...
func (o *Location) RemoveTrainings(ctx context.Context, exec boil.ContextExecutor, related ...*Training) error {
	if len(related) == 0 {
		return nil
	}
