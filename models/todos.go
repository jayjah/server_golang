...
type Todo struct {
	...
	Isdone           bool        `boil:"isdone" json:"isdone" toml:"isdone" yaml:"isdone"`
...
var TodoWhere = struct {
	...
	Shortdescription: whereHelpernull_String{field: "\"todos\".\"shortdescription\""},
	Isdone:           whereHelperbool{field: "\"todos\".\"isdone\""},
	Enddate:          whereHelpertime_Time{field: "\"todos\".\"enddate\""},
	ID:               whereHelperint64{field: "\"todos\".\"id\""},
	Name:             whereHelperstring{field: "\"todos\".\"name\""},
	Text:             whereHelpernull_String{field: "\"todos\".\"text\""},
	Createdat:        whereHelpertime_Time{field: "\"todos\".\"createdat\""},
	Updatedat:        whereHelpertime_Time{field: "\"todos\".\"updatedat\""},
...
var (
	todoAllColumns            = []string{"shortdescription", "isdone", "enddate", "id", "name", "text", "createdat", "updatedat", "user_id"}
	todoColumnsWithoutDefault = []string{"enddate", "name", "user_id"}
	todoColumnsWithDefault    = []string{"shortdescription", "isdone", "id", "text", "createdat", "updatedat"}
